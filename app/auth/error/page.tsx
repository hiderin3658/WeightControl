...
function ErrorLoadingFallback() {
  return (
    <div className="backdrop-blur-lg bg-white/30 rounded-2xl p-8 shadow-lg max-w-md w-full text-center">
      <div className="animate-pulse">
        <div className="mx-auto h-16 w-16 bg-red-200 rounded-full mb-4"></div>
        <div className="h-6 bg-gray-200 rounded w-3/4 mx-auto mb-2"></div>
        <div className="h-4 bg-gray-200 rounded w-1/2 mx-auto mb-6"></div>
        <div className="h-10 bg-blue-200 rounded-lg w-40 mx-auto"></div>
      </div>
    </div>
  );
}
